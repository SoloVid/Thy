...
const argv = yargs(process.argv.slice(2)).options({
  target: {
    alias: "t",
    choices: ["ts-namespace"] as const,
    demandOption: true,
    description: "Target format of compiled output",
  },
  rootDir: {
    alias: "r",
    type: "string",
    default: ".",
    description: "Root directory containing Thy source files",
  },
  outDir: {
    alias: "o",
    type: "string",
    default: ".",
    description: "Output directory for compiled output files",
  },
}).argv
