...
export const numberTypeGenerator = makePrimitiveTypeGenerator(
  "Number",
  "number",
)
export const stringTypeGenerator = makePrimitiveTypeGenerator(
  "String",
  "string",
)
export const unknownTypeGenerator = makePrimitiveTypeGenerator(
  "Unknown",
  "unknown",
)
