...
renderStandardPage(
  ...
  <>
    ...
    <div class="column-content-sm">
      ...
      <p>
        Every line in Thy has <strong>exactly one function call</strong>. The
        output of the function can optionally be captured in a variable.
      </p>
      <p>
    ...
    <div class="column-content-sm">
      <h4>Conditionals</h4>
      <p>
        Conditionals in Thy are all done with the <code>if</code>{" "}
        <em>function</em>.
      </p>
    </div>
    <div class="column-content-md">
    ...
    <div class="column-content-sm">
      ...
      <p>
        Note: Thy has a dedicated keyword <code>let</code> to allow early
        returns, since loops and conditionals are not a language-level
        construct.
      </p>
    </div>
    <div class="column-content-md">
    ...
    <div class="column-content-sm">
      ...
      <p>
        Objects are implemented as a language feature in Thy. Arrays are built
        with a standard library function.
      </p>
    </div>
    <div class="column-content-md">
      <TsThyComparison
    ...
    <div class="column-content-sm">
      <h4>Functions</h4>
      <p>
        Functions in Thy are more akin to arrow functions in TypeScript than to
        traditional <code>function</code>s in JavaScript.
      </p>
      <p>
    ...
    <div class="column-content-sm">
      ...
      <p>
        Error handling should feel pretty similar to TypeScript. Again, like{" "}
        <code>if</code>, <code>try</code> is just a standard library function.
      </p>
    </div>
    <div class="column-content-md">
      <TsThyComparison
    ...
    <div class="column-content-sm">
      <p>
        Thy's format basically translates to an arrow function returning an
        object literal.
      </p>
      <p>
        Thy's <code>private</code> and <code>export</code> keywords can be
    ...
    <div class="column-content-sm">
      <h4>Comments</h4>
      <p>
        Comments in Thy are lines that start with a capital letter. Yes, this
        means that your variables all have to start with lower-case letters.
      </p>
      <p>
        Multi-line comments in Thy are started with 3+ capital letters and ended
