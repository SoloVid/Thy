...
export const ascBuiltin = (_a: number, _b: number, _c: number = _b + 1, _d: number = _c + 1) =>
  _a < _b && _b < _c && _c < _d
export const descBuiltin = (_a: number, _b: number, _c: number = _b - 1, _d: number = _c - 1) =>
  _a > _b && _b > _c && _c > _d
export const equalBuiltin = (_a: unknown, _b: unknown, _c: unknown = _b, _d: unknown = _c) =>
  _a === _b && _b === _c && _c === _d
